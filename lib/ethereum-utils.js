...
var EthrDIDRegistryAbi = RevokeAndPublishArtifact.abi;
var EthrDIDRegistryAddress = RevokeAndPublishArtifact.networks[1].address;

var PROVIDER_URL = 'https://mainnet.infura.io';
var claimKey = '0x' + Buffer.from('muPortDocumentIPFS1220', 'utf8').toString('hex');
