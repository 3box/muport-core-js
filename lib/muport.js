...
var MuPort = function () {
  ...
  (0, _createClass3.default)(MuPort, [{
        ...
        return _regenerator2.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                signer = (0, _didJwt.SimpleSigner)(this.keyring.signingKey._hdkey._privateKey);
                _context5.next = 3;
                return (0, _didJwt.createJWT)(payload, { issuer: this.did, signer: signer });
    ...
    key: 'newIdentity',
    value: function () {
      var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(name, delegateDids) {
        var _this3 = this;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 8;
                return _promise2.default.all(delegateDids.map(function () {
                  var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(did) {
                    return _regenerator2.default.wrap(function _callee6$(_context6) {
                      while (1) {
                        switch (_context6.prev = _context6.next) {
                          ...
                          case 2:
                            return _context6.abrupt('return', _context6.sent.asymEncryptionKey);
              ...
              case 8:
                didsPublicKeys = _context7.sent;
                _context7.next = 11;
                return keyring.createShares(delegateDids, didsPublicKeys);

              case 11:
                recoveryNetwork = _context7.sent;
              ...
              case 17:
                docHash = _context7.sent;
                did = 'did:muport:' + docHash;
                return _context7.abrupt('return', new MuPort((0, _extends3.default)({
                  did: did,
                  document: doc,
    ...
    key: 'recoverIdentity',
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(did, shares) {
        var opts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                initIpfs(opts.ipfsConf);
                _context8.t0 = MuPort;
                _context8.t1 = _extends3.default;
                _context8.t2 = did;
                _context8.next = 6;
                return MuPort.resolveIdentityDocument(did, opts);
              ...
              case 9:
                _context8.t4 = _context8.sent.serialize();
                _context8.t5 = {
                  did: _context8.t2,
                  document: _context8.t3,
                  keyring: _context8.t4
                };
                _context8.t6 = opts;
                _context8.t7 = (0, _context8.t1)(_context8.t5, _context8.t6);
                return _context8.abrupt('return', new _context8.t0(_context8.t7));
      ...
      function recoverIdentity(_x11, _x12) {
    ...
    value: function () {
      var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(did, opts) {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 3:
                ...
                return _context9.abrupt('return', createMuportDocument(publicKeys, recoveryNetwork, publicProfile, symEncryptedData));
      ...
      function resolveIdentityDocument(_x13, _x14) {
