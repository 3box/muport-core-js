  ...
  (0, _createClass3.default)(MuPort, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(delegateDids) {
        ...
        var didsPublicKeys, address, txParams, costInEther, signedTx;
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 7:
                this.document.recoveryNetwork = _context4.sent;

                console.log('hash before: ' + this.documentHash);
                console.log(this.document.symEncryptedData.symEncDids);

                // save guardians
                this.document.symEncryptedData.symEncDids = delegateDids.map(function (did) {
              ...
              case 13:
                ...
                console.log('hash after: ' + this.documentHash);
                console.log(this.document.symEncryptedData.symEncDids);
