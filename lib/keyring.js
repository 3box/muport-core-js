...
var Keyring = function () {
  ...
  _createClass(Keyring, [{
    key: 'createShares',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dids, publicKeys) {
    ...
    value: function decryptOneShare(recoveryNetwork, fromPublic, did) {
      ...
      try {
        for (var _iterator = recoveryNetwork.ciphertexts[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var box = _step.value;
    ...
    key: 'recoverKeyring',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(shares) {
        var entropy;
