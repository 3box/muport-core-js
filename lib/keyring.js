...
var Keyring = function () {
  function Keyring() {
    ...
    var mnemonic = opts.mnemonic || bip39.generateMnemonic();
  ...
  (0, _createClass3.default)(Keyring, [{
    ...
    key: '_initKeysFromMnemonic',
    value: function _initKeysFromMnemonic(mnemonic) {
      ...
      var tmpEncKey = this.baseKey.deriveChild(2)._hdkey._privateKey;
    ...
    key: 'recoverKeyring',
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(shares) {
        var entropy;
